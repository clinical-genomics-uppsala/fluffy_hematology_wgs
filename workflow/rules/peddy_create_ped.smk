...
rule peddy_create_ped:
    ...
    threads: config.get("peddy_create_ped", {}).get(
    "threads", config["default_resources"]["threads"]
)
    resources:
        mem_mb=config.get("peddy_create_ped", {}).get(
            "mem_mb", config["default_resources"]["mem_mb"]
        ),
        mem_per_cpu=config.get("peddy_create_ped", {}).get(
            "mem_per_cpu", config["default_resources"]["mem_per_cpu"]
        ),
        partition=config.get("peddy_create_ped", {}).get(
            "partition", config["default_resources"]["partition"]
        ),
        threads=config.get("peddy_create_ped", {}).get(
            "threads", config["default_resources"]["threads"]
        ),
        time=config.get("peddy_create_ped", {}).get(
...
rule combine_peddy_results:
    ...
    resources:
        mem_mb=config.get("combine_peddy_results", {}).get(
            "mem_mb", config["default_resources"]["mem_mb"]
        ),
        mem_per_cpu=config.get("combine_peddy_results", {}).get(
            "mem_per_cpu", config["default_resources"]["mem_per_cpu"]
        ),
        partition=config.get("combine_peddy_results", {}).get(
            "partition", config["default_resources"]["partition"]
        ),
        threads=config.get("combine_peddy_results", {}).get(
            "threads", config["default_resources"]["threads"]
        ),
        time=config.get("combine_peddy_results", {}).get(
            "time", config["default_resources"]["time"]
        ),
    container:
        config.get("combine_peddy_results", {}).get(
...
rule create_peddy_mqc_tsv:
    ...
    resources:
        mem_mb=config.get("create_peddy_mqc_tsv", {}).get(
            "mem_mb", config["default_resources"]["mem_mb"]
        ),
        mem_per_cpu=config.get("create_peddy_mqc_tsv", {}).get(
            "mem_per_cpu", config["default_resources"]["mem_per_cpu"]
        ),
        partition=config.get("create_peddy_mqc_tsv", {}).get(
            "partition", config["default_resources"]["partition"]
        ),
        threads=config.get("create_peddy_mqc_tsv", {}).get(
            "threads", config["default_resources"]["threads"]
        ),
        time=config.get("create_peddy_mqc_tsv", {}).get(
            "time", config["default_resources"]["time"]
        ),
    container:
        config.get("create_peddy_mqc_tsv", {}).get(
            "container", config["default_container"]
        )
    message:
